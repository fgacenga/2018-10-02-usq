...
<div id="shell"> {% comment %} Start of 'shell' section. {% endcomment %}
  ...
  <div class="row">
    <div class="col-md-4">
      ...
      <ol>
        <li>For Windows computers please also install PuTTY. PuTTY is an SSH and telnet client. Install from <a href="http://www.putty.org/">installer</a> or or if using a USQ computer from within USQ install from:<a href="https://kace.usq.edu.au/userui/software_detail.php?ID=452">installer</a>.</li>
